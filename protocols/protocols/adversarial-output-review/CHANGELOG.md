# Changelog — adversarial-output-review
...
- First version of the protocol: contract (`protocol.yaml`), skill (`SKILL.md`),
  README (the ten questions), a one-page adversarial-review checklist, review and
  receipt templates, a worked example that doubles as the test fixture, structural
  test cases with positive, failure/boundary, and discrimination cases, the
  `aor-core-v1` three-arm eval task set (design only, not executed), and four
