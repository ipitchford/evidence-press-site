...
art['triangulated-graph-product-picard'] = (a,b) => {
  ...
  for(let i=0;i<3;i++)for(let j=0;j<4;j++){
    const x=60+90*j,y=50+90*i;
    s+=`<rect x="${x}" y="${y}" width="90" height="90" fill="none" stroke="${a}" stroke-width="3"/>`;
    s+=`<path d="M${x} ${y+((i+j)%2?90:0)} L${x+90} ${y+((i+j)%2?0:90)}" stroke="${b}" stroke-width="2"/>`;
  }
...
// Davies–Levitin lens: exact disks |λ∓c|<2 at c=0.6 and the 260 computed non-real eigenvalues for n=1..24 (numpy/scipy generalised eig, offline).
art['davies-levitin-lens-conjecture'] = (a,b) => {
 const g='#8a979c', t='#edf3ee', S=85, ox=330, oy=200, cx=51.0, R=170;
 const P=[[330.0,132.0,1],[330.0,268.0,1],[283.6,174.3,3],[283.6,225.7,3],[376.4,174.3,3],[376.4,225.7,3],[245.0,182.8,4],[245.0,217.2,4],[415.0,182.8,4],[415.0,217.2,4],[330.0,163.0,4],[330.0,237.0,4],[295.6,172.2,5],[295.6,227.8,5],[364.4,172.2,5],[364.4,227.8,5],[267.1,196.1,6],[267.1,203.9,6],[330.0,173.2,6],[330.0,226.8,6],[392.9,196.1,6],[392.9,203.9,6],[225.0,194.1,7],[225.0,205.9,7],[435.0,194.1,7],[435.0,205.9,7],[258.0,189.8,8],[258.0,210.2,8],[309.5,183.9,8],[309.5,216.1,8],[402.0,189.8,8],[402.0,210.2,8],[350.5,183.9,8],[350.5,216.1,8],[240.6,195.3,9],[240.6,204.7,9],[287.5,184.8,9],[287.5,215.2,9],[419.4,195.3,9],[419.4,204.7,9],[330.0,178.5,9],[330.0,221.5,9],[372.5,184.8,9],[372.5,215.2,9],[217.2,197.5,10],[217.2,202.5,10],[268.7,190.6,10],[268.7,209.4,10],[311.5,181.1,10],[311.5,218.9,10],[442.8,197.5,10],[442.8,202.5,10],[348.5,181.1,10],[348.5,218.9,10],[391.3,190.6,10],[391.3,209.4,10],[240.1,197.3,11],[240.1,202.7,11],[293.7,188.9,11],[293.7,211.1,11],[419.9,197.3,11],[419.9,202.7,11],[330.0,181.7,11],[330.0,218.3,11],[366.3,188.9,11],[366.3,211.1,11],[431.5,197.5,12],[431.5,202.5,12],[228.5,197.5,12],[228.5,202.5,12],[262.7,196.2,12],[262.7,203.8,12],[397.3,196.2,12],[397.3,203.8,12],[314.8,191.4,12],[314.8,208.6,12],[345.2,191.4,12],[345.2,208.6,12],[249.4,193.9,13],[249.4,206.1,13],[283.5,191.8,13],[283.5,208.2,13],[410.6,193.9,13],[410.6,206.1,13],[316.9,188.7,13],[316.9,211.3,13],[343.1,188.7,13],[343.1,211.3,13],[376.5,191.8,13],[376.5,208.2,13],[269.4,192.0,14],[269.4,208.0,14],[301.8,188.0,
],[338.8,208.5,22],[359.6,199.0,22],[359.6,201.0,22],[217.4,198.9,23],[217.4,201.1,23],[262.1,195.6,23],[262.1,204.4,23],[282.2,194.9,23],[282.2,205.1,23],[442.6,198.9,23],[442.6,201.1,23],[303.1,195.2,23],[303.1,204.8,23],[397.9,195.6,23],[397.9,204.4,23],[322.6,193.8,23],[322.6,206.2,23],[337.4,193.8,23],[337.4,206.2,23],[377.8,194.9,23],[377.8,205.1,23],[356.9,195.2,23],[356.9,204.8,23],[231.5,198.2,24],[231.5,201.8,24],[273.9,195.0,24],[273.9,205.0,24],[293.6,193.5,24],[293.6,206.5,24],[313.1,191.7,24],[313.1,208.3,24],[428.5,198.2,24],[428.5,201.8,24],[330.0,189.9,24],[330.0,210.1,24],[386.1,195.0,24],[386.1,205.0,24],[346.9,191.7,24],[346.9,208.3,24],[366.4,193.5,24],[366.4,206.5,24]];
 let s=`<defs><clipPath id="dl-left"><circle cx="${ox-cx}" cy="${oy}" r="${R}"/></clipPath></defs><g font-family="Arial, sans-serif">`;
 s+=`<path d="M60 ${oy} H600 M${ox} 22 V378" stroke="${g}" stroke-opacity=".45" stroke-width="1.5"/>`;
 s+=`<circle cx="${ox+cx}" cy="${oy}" r="${R}" fill="${a}" fill-opacity=".16" clip-path="url(#dl-left)"/>`;
 for(const x of [ox-cx, ox+cx]) s+=`<circle cx="${x}" cy="${oy}" r="${R}" fill="none" stroke="${a}" stroke-width="2.5" opacity=".8"/><circle cx="${x}" cy="${oy}" r="3.5" fill="${a}"/>`;
 for(const [x,y,n] of P) s+=`<circle cx="${x}" cy="${y}" r="2.6" fill="${b}" fill-opacity="${(0.45+0.55*n/24).toFixed(2)}"/>`;
 s+=`<text class="og-hide" x="${ox-cx}" y="${oy+24}" text-anchor="middle" fill="${a}" font-size="16">−c</text><text class="og-hide" x="${ox+cx}" y="${oy+24}" text-anchor="middle" fill="${a}" font-size="16">+c</text>`;
 s+=`<text class="og-hide" x="${ox}" y="392" text-anchor="middle" fill="#cbd5d1" font-family="monospace" font-size="15">c = 0.6 · n = 1…24 · 260 computed eigenvalues</text>`;
 s+=`<text class="og-hide" x="880" y="100" text-anchor="middle" fill="#e7e5e4" font-family="Georgia" font-size="34">Where the complex eigenvalues live</text>`;
 s+=`<text class="og-hide" x="880" y="175" text-anchor="middle" fill="${a}" font-family="Georgia" font-size="29">Davies–Levitin lens: every n</text>`;
 s+=`<text class="og-hide" x="880" y="250" text-anchor="middle" fill="${b}" font-family="monospace" font-size="21">|λ − c| &lt; 2 and |λ + c| &lt; 2</text>`;
 s+=`<text class="og-hide" x="880" y="325" text-anchor="middle" fill="#cbd5d1" font-family="monospace" font-size="17">UNREFEREED CANDIDATE</text></g>`;
 return s;
};
