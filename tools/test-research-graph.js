...
ok(graph.nodes.find(node => node.id === 'method:adversarial-controls').releaseAssignmentCount === 27 &&
  graph.nodes.find(node => node.id === 'method:structural-compression').releaseAssignmentCount === 24,
