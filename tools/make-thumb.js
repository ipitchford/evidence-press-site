...
const SPECS = {
  ...
  'amplitude-modules-fused-support-bautin-bound': {
    palette: 'lagoon',
    kicker: ['RESEARCH RELEASE · 28 AUGUST 2026', 'POLYNOMIAL PHASES · V0.1.0-CANDIDATE'],
    head: ['Modules fuse.', 'The cutoff is <em>d−1.</em>'],
    headSize: 66,
    sub: 'Two all-amplitude classifications and one ordinary coefficient-Bautin theorem candidate turn inverse support into explicit modules and a finite stopping rule.',
    tag: 'ANONYMOUS · UNREFEREED THEOREM CANDIDATE',
    hero: `
      <div class="eq-label">three scoped candidate results</div>
      <div class="eq eq-sm">Dickson: <span class="hl">q = 2N + ε</span></div>
      <div class="note"><b>Ritt collision:</b> every rank 0,…,11<br><b>Coefficient ideal:</b> generated by M₁,…,M<sub>d−1</sub></div>
      <div class="eq-foot">producer replay passed · independent validation open</div>`
  },
